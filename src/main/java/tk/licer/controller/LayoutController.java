...
public class LayoutController {
	...
	Log logger = LogFactory.getLog(LayoutController.class);
	 ...
	 */
	@RequestMapping(value="layout")
	public ModelAndView layout(HttpServletRequest req, HttpServletResponse resp){
	...
	public ModelAndView menu(HttpServletRequest req, HttpServletResponse resp){
		...
		ModelAndView mv = new ModelAndView("layout/menu");
		return mv;
	}
