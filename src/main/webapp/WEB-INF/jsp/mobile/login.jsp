...
<link href="mobile/css/mui.min.css" rel="stylesheet" />
...
<body>
	...
	<div class="mui-content">
		...
		<div class="mui-content-padded">
			<button id='login' class="mui-btn mui-btn-block mui-btn-primary" onclick="window.location.href='layout/layout' ">登录</button>
			<div class="link-area">
	...
	<script src="mobile/js/mui.enterfocus.js"></script>
			...
			$
					.plusReady(function() {
						...
						if (settings.autoLogin && state.token
							...
							app.setState(null);
							//第三方登录
							var authBtns = [ 'qihoo', 'weixin', 'sinaweibo',
									'qq' ]; //配置业务支持的第三方登录
							var auths = {};
													...
													if (~authBtns
														...
														btn
																.setAttribute(
																		...
																		'oauth-btn'
																				+ (!isInstalled
																						&& service.id === 'weixin' ? (' disabled')
																						: ''));
														btn.authId = service.id;
														btn.style.backgroundImage = 'url("images/'
																+ service.id
																+ '.png")'
														oauthArea
																.appendChild(btn);
						...
						autoLoginButton.classList[settings.autoLogin ? 'add'
								: 'remove']('mui-active')
						autoLoginButton.addEventListener('toggle', function(
								event) {
							setTimeout(function() {
						...
						window
								.addEventListener(
										'resize',
										function() {
											oauthArea.style.display = document.body.clientHeight > 400 ? 'block'
													: 'none';
										}, false);
						//
